Run `mvn clean install` in the Maven project directory and wait for the compilation and packaging to finish. Then, run `java -jar target/file-systems-0.0.1-SNAPSHOT.jar`. You should see something like:
